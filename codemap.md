...
- Playlist pages include daily YouTube suggestion discovery: five cached suggestions per playlist/browser/day via the server-side YouTube API proxy, with one local re-suggest per day.
